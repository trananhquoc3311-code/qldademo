...
export const reminders = [
  { id: 1, title: 'Duyệt báo cáo giải ngân quý III', meta: 'Phòng Tài chính · Hạn 20/08', tone: 'urgent' },
  { id: 2, title: 'Bổ sung số liệu cải cách hành chính', meta: 'Văn phòng · Hạn 22/08', tone: 'warning' },
  { id: 3, title: 'Họp giao ban với Phòng Kế hoạch', meta: 'Lịch tuần · 14:00 hôm nay', tone: 'info' },
]
